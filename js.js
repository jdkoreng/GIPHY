...
var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
      ...
      $.ajax({
        ...
        //   StillPersonImage = $("<img>");
        //   StillPersonImage.attr("src", results[i].images.fixed_height.url);
        //   StillPersonImage.attr("imageNumber", i);
        //   StillPersonImage.attr("still", true);
        //   StillPersonImage.addClass("personImage");
